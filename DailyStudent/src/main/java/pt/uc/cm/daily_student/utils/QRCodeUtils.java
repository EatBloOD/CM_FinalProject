...
public class QRCodeUtils {
    ...
    private static QRCodeUtils qrCodeUtils = null;
    ...
    public static QRCodeUtils newInstance(Context context) {
        if (qrCodeUtils == null) {
    ...
    public QRCodeUtils setErrorCorrectionLevel(ErrorCorrectionLevel level) {
    ...
    public QRCodeUtils setContent(String content) {
        mContent = content;
        return this;
    }
    ...
    public QRCodeUtils setWidthAndHeight(@IntRange(from = 1) int width, @IntRange(from = 1) int height) {
        mWidth = width;
        mHeight = height;
        return this;
    }
    ...
    public QRCodeUtils setMargin(@IntRange(from = 0) int margin) {
        mMargin = margin;
        return this;
    }
